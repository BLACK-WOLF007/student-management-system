...
<body>
    <div class="wrapper">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="form-group">
                <input type="submit" class="btn btn-primary" value="Login" style="background:#fdcf5b; color:#000;">
            </div>
            <p>Don't have an account? <a href="index.php" style="color:#fc6264;">Sign up now</a>.</p>
        </form>
    </div>
</body>
</html>