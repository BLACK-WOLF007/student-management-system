...
<body>
    <div class="wrapper">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="form-group">
                <input type="submit" id="sub-btn" class="btn btn-primary" value="Submit" style="background:#fdcf5b; color:#000;">
                <input type="reset" class="btn btn-secondary ml-2" value="Reset">
            </div>
            <p>Already have an account? <a href="login.php" style="color:#fc6264;">Login here</a>.</p>
        </form>
    </div>    
</body>
</html>